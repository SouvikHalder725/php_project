...
?>
        ...
        <div class="container col-md-12 text-dark border border-3 rounded-4" style="height:100%; border-radius: 15px; background-color:  #f5f5dc;">
               <div class="row bg-secondary my-1 col-md-12" style="width:100%;">
                  <div class="col-md-8">
                    <h3 class="text-center text-light my-2">Add New Solution Type</h3>
                  </div>
                  ...
                  <div class="col-md-2">
                    <a href="solution_type_list.php" class="btn btn-primary my-2" style="font-size: 15px;"><i class="fa fa-table mx-1"></i>All Solution Type List</a>
                  </div>
                ...
                <div class="row col-md-12">
                   ...
                   <form action="../operation/add_new_sol_type_op.php" method="post">
                       ...
                       <div class="d-flex col-md-6 my-2">
                        ...
                        <div class="d-flex col-md-6 my-2">
                          ...
                          <div class="col-md-8">
                            <input type="text" class="form-control" id="type_of_sol" name="type_of_sol" required>
