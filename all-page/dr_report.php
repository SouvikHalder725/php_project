...
?>
 <div class="container col-md-12 text-dark border border-3 rounded-4" style="height:100%; border-radius: 15px; background-color:  #f5f5dc;">
               <div class="row bg-secondary my-1 col-md-12" style="width:100%;">
                  <div class="col-md-10">
                    <h3 class="text-center text-light my-2">DR Report List List</h3>
                  </div>

                   <div class="col-md-2">
                    <a href="dr_report.php" class="btn btn-info my-2" style="font-size: 15px;"><i class="fa fa-refresh mx-1"></i>Refresh List</a>
                  </div>
              ...
              <div class="col-md-12 bg-primary" style="align-content: center; align-items: center; text-align: center;">
                  ...
                  <a href="../pdf_generate/pdf_dr_print.php?eng_id=<?php echo $eng_id; ?>&start_date=<?php echo $start_date; ?>&end_date=<?php echo $end_date; ?>" class="btn btn-light border-2 border-dark rounded-3 text-center text-dark my-2 mx-2">Print<?php //echo $page; ?></a>
                  <a href="export_dr_excel.php?eng_id=<?php echo $eng_id; ?>&start_date=<?php echo $start_date; ?>&end_date=<?php echo $end_date; ?>" class="btn btn-light border-2 border-dark rounded-3 text-center text-dark my-2 mx-2">Export to Excel<?php //echo $page; ?></a>
